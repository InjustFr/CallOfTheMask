...
@onready var projectile_scene := preload("res://entities/projectiles/enemy/enemy_projectile.tscn")
...
func spawn_splash_projectiles() -> void:
	for i in nb_projectiles_splash:
		...
		var angle := 2 * PI / nb_projectiles_splash * i
		var dir := Vector2.RIGHT.rotated(angle)
		projectile_spawner_component.spawn_towards_target(dir, projectile_spawn_radius)
