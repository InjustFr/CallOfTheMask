...
func open() -> void:
	...
	map.set_cell(0, Vector2i(-1, -1), 0, Vector2i(0, 9), 0)
...
func close() -> void:
	...
	map.set_cell(0, Vector2i(-1, -1), 0, Vector2i(0, 7), 0)

func disable() -> void:
	disabled = true
	door_area.monitoring = false
	map.set_cell(0, Vector2i(-1, -1), 0, Vector2i(2, 0), 0)
	map.set_cell(0, Vector2i(0, -1), 0, Vector2i(3, 0), 0)
