...
func open() -> void:
	...
	map.set_cell(Vector2i(-1, 0), 0, Vector2i(6, 7), 0)
...
func close() -> void:
	...
	map.set_cell(Vector2i(-1, 0), 0, Vector2i(4, 7), 0)

func disable() -> void:
	close()
	disabled = true
	map.set_cell(Vector2i(-1, -1), 0, Vector2i(0, 3), 0)
	map.set_cell(Vector2i(-1, 0), 0, Vector2i(0, 4), 0)
